...
<Card title="Every card is a resource">
  In Nexus, all cards can used as resources, by converting and playing them as
  their anomaly mode instead of their initial mode.
  <br />
  <img src="/images/download/tabletop-simulator.png" />
</Card>

Often in card games, resource cards, like anomalies, are shuffled into a players deck together with other cards. In Nexus, that's not the case.
Every card in Nexus has two modes it can be played as: the initial mode and the anomaly mode.
